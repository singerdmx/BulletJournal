...
import {ShareAltOutlined, UserSwitchOutlined, TeamOutlined, LinkOutlined, ToolOutlined} from '@ant-design/icons';
...
const ShareProjectItem: React.FC<ProjectItemProps> = props => {
    ...
    const getModal = () => {
        ...
        return (
            ...
            >
                <div>
                    <Tabs defaultActiveKey='Group' tabPosition={'left'} onTabClick={(k: string) => handleTabClick(k)}>
                        <TabPane tab={
                            <Tooltip title='Group'>
