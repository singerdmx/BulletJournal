...
export const importTasks = (isMobile: boolean, window: Window,
    ...
    isMobile: isMobile, window: window, sampleTasks: sampleTasks, selections: selections, categoryId: categoryId,
