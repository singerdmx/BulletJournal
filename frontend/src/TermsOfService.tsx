...
const TermsOfServicePage: React.FC<PageProps> = (props) => {
  return <div style={{padding: '55px'}}>
    <p>The following terms and conditions govern all use of the <a href="//bulletjournal.us">bulletjournal.us</a> website and all
      content, services and products available at or through the website, including, but not limited to, <a
          href="//bulletjournal.us">bulletjournal.us</a> Software
      and the <a href="//bulletjournal.us">bulletjournal.us</a> Hosting service (“Hosting”), (taken together, the Website). The
      Website is owned and operated by bulletjournal. The Website is offered subject to your acceptance without
      modification of all of the terms and conditions contained herein and all other operating rules, policies
      (including, without limitation, <a href="//bulletjournal.us">bulletjournal.us</a>’s <a href="/public/privacy">Privacy
        Policy</a> and procedures that may be published from time to time
      on this Site by bulletjournal (collectively, the “Agreement”).</p>
    ...
    <ul>
      <li>the downloading, copying and use of the Content will not infringe the proprietary rights, including but not
        limited to the copyright, patent, trademark or trade secret rights, of any third party;
      </li>
      <li>if your employer has rights to intellectual property you create, you have either (i) received permission from
      ...
      <li>the Content is not spam, is not machine- or randomly-generated, and does not contain unethical or unwanted
        commercial content designed to drive traffic to third party sites or boost the search engine rankings of third
        party sites, or to further unlawful acts (such as phishing) or mislead recipients as to the source of the
        material (such as spoofing);
      </li>
      <li>the Content is not pornographic, does not contain threats or incite violence, and does not violate the privacy
        or publicity rights of any third party;
      </li>
      <li>your content is not getting advertised via unwanted electronic messages such as spam links on newsgroups,
        email lists, blogs and web sites, and similar unsolicited promotional methods;
      </li>
      <li>your content is not named in a manner that misleads your readers into thinking that you are another person or
        company; and
      </li>
      <li>you have, in the case of Content that includes computer code, accurately categorized and/or described the
    ...
    <p>User contributions are licensed under a <a href="https://creativecommons.org/licenses/by-nc-sa/3.0/deed.en_US">Creative
      ...
      (i) refuse or remove any content that, in bulletjournal’s reasonable opinion, violates any bulletjournal policy or is in any
    ...
    <p>Optional paid services or upgrades may be available on the Website. When utilizing an optional paid service or
      ...
      pre-pay basis on the day you begin utilizing the service or upgrade and will cover the use of that service or
      upgrade for a monthly or annual subscription period as indicated. These fees are not refundable.</p>
    <h3>Automatic Renewal</h3>
    <p>Unless you notify bulletjournal before the end of the applicable subscription period that you want to cancel a service
    ...
    <p>We have not reviewed, and cannot review, all of the material, including computer software, made available through
      the websites and webpages to which <a href="//bulletjournal.us">bulletjournal.us</a> links, and that link to <a
          ...
          href="http://non-bulletjournal.us">non-bulletjournal.us</a> websites and webpages, and is not responsible for their
      contents or their use. By linking to a <a href="http://non-bulletjournal.us">non-bulletjournal.us</a> website or webpage,
      bulletjournal does not represent or imply that it endorses such website or webpage. You are responsible for taking
    ...
    <p>As bulletjournal asks others to respect its intellectual property rights, it respects the intellectual property rights
      ...
      encouraged to notify bulletjournal in accordance with bulletjournal’s <a
          href="https://en.wikipedia.org/wiki/Digital_Millennium_Copyright_Act">Digital Millennium Copyright
        Act</a> (“DMCA”) Policy. bulletjournal will respond to all such notices, including as required or appropriate by
      removing the infringing material or disabling all links to the infringing material. bulletjournal will terminate a
    ...
    <p>This Agreement does not transfer from bulletjournal to you any bulletjournal or third party intellectual property, and all
      ...
      trademarks, service marks, graphics and logos used in connection with <a href="//bulletjournal.us">bulletjournal.us</a>, or
      the Website are trademarks or registered trademarks of bulletjournal or bulletjournal’s licensors. Other trademarks, service
    ...
    <p>The Website is provided “as is”. bulletjournal and its suppliers and licensors hereby disclaim all warranties of any
      ...
      the Website will be error free or that access thereto will be continuous or uninterrupted. If you’re actually
      reading this, here’s <a
    ...
    <p>This Agreement constitutes the entire agreement between bulletjournal and you concerning the subject matter hereof, and
      ...
      any access to or use of the Website will be governed by the laws of the state of California, U.S.A., excluding its
      ...
      agrees to be bound by, its terms and conditions; bulletjournal may assign its rights under this Agreement without
    ...
    <p>Originally adapted from the <a href="https://en.wordpress.com/tos/">WordPress Terms of Service</a>.</p>
  </div>
};
