...
import {DeleteTwoTone, FileDoneOutlined, LoadingOutlined, PlusCircleTwoTone, TagOutlined, AlertOutlined, UpSquareOutlined} from '@ant-design/icons';
// modals import
            ...
            <div className="task-title">
                ...
                <div className="task-operation">
                    ...
                    <Tooltip title='Go to Parent BuJo'>
                        <div>
                            <UpSquareOutlined onClick={e => history.push(`/projects/${task.projectId}`)}/>
                        </div>
                    </Tooltip>
                </div>
            </div>
