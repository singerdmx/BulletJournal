...
public class RelationsProcessorTest {
    ...
    public void testRemoveTargetProject() {
        ...
        String projectRelations = RelationsProcessor.processRelations(projectHierarchy);
    ...
    /**
     * Tests {@link RelationsProcessor#processRelations(Map, String, Set)}
     */
    @Test
    public void testProjectRelationsProcessor() {
        ...
        String projectRelations = RelationsProcessor.processRelations(
        ...
        projects = RelationsProcessor.processRelations(projectMap, projectRelations, null);
        ...
        projects = RelationsProcessor.processRelations(projectMap, projectRelations,
