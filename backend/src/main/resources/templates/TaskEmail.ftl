  ...
  <div style="width:100%;">
    <div style="padding-top: 10px; padding-bottom: 10px;">
      <div style="height: 25px; float: left">
        ...
        <div style="float: left">
          <span style="margin-left: 5px; color: #cc99ff;font-size: 17px;">&nbsp;${task_name}&nbsp;</span>
        </div>
        <div style="float: left">
        ...
        <#if due_date?has_content>
          <div style="float: left">
            <span style="font-size: 17px">&nbsp;Due at </span>
          </div>
          <div style="float: left">
            <span style="margin-left: 5px; color: #cc99ff;font-size: 17px;">${due_date}.</span>
          </div>
        </#if>
      </div>
    </div>
