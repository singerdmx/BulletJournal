...
public class UserPointActivity extends AuditModel {
    ...
    public UserPointActivity(User user, Integer pointChange, String description) {
        this.user = user;
    ...
    public com.bulletjournal.controller.models.UserPointActivity toPresentationModel() {
        return new com.bulletjournal.controller.models.UserPointActivity(
                this.getId(), new com.bulletjournal.controller.models.User(this.getUser().getName()), this.getDescription(), this.getPointChange(),
