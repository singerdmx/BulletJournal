...
public enum ContentAction {
    ...
    UPDATE_TASK, MOVE_TASK, ADD_NOTE, DELETE_NOTE, UPDATE_NOTE, MOVE_NOTE, ADD_TRANSACTION, DELETE_TRANSACTION, UPDATE_TRANSACTION,
    MOVE_TRANSACTION, ADD_TASK_CONTENT, DELETE_TASK_CONTENT, UPDATE_TASK_CONTENT, ADD_NOTE_CONTENT, DELETE_NOTE_CONTENT,
