...
func request_Daemon_RestSend_0(ctx context.Context, marshaler runtime.Marshaler, client DaemonClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.RestSend(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Daemon_RestSend_0(ctx context.Context, marshaler runtime.Marshaler, server DaemonServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq types.JoinGroupEvents
	var metadata runtime.ServerMetadata
	...
	msg, err := server.RestSend(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDaemonHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DaemonServer) error {
	...
	mux.Handle("POST", pattern_Daemon_RestSend_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Daemon_RestSend_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Daemon_RestSend_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDaemonHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DaemonClient) error {
	...
	mux.Handle("POST", pattern_Daemon_RestSend_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Daemon_RestSend_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Daemon_RestSend_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"send"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Daemon_RestSend_0 = runtime.ForwardResponseMessage
)
